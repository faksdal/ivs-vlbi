...
curl --location --cookie cookies.txt https://cddis.nasa.gov/archive/vlbi/ivscontrol/master2025.txt > master2025.txt
curl --location --cookie cookies.txt https://cddis.nasa.gov/archive/vlbi/ivscontrol/master2025-int.txt > master2025-int.txt
